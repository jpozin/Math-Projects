...
def TriangleAngles(alist):
	"""Determine the angles of a triangle given a list of its points
...
def isObtuse(alist):
	"""Determine whether a triangle is an obtuse triangle given a list of its points
	The list must contain three tuples of the form (x, y)
	This function does not check to ensure this requirement is met"""
...
def isRight(alist):
	"""Determine whether a triangle is a right triangle given a list of its points
	The list must contain three tuples of the form (x, y)
	This function does not check to ensure this requirement is met
...
def isAcute(alist):
	"""Determine whether a triangle is an acute triangle given a list of its points
	The list must contain three tuples of the form (x, y)
	This function does not check to ensure this requirement is met
	This function is supplementary and is not used in this module"""
	for angle in TriangleAngles(alist):
...
if __name__ == '__main__':
	...
	mystr =\
f"""The mean probability of a triangle being acute is:  {round(mean(totalProbs), 2)}
